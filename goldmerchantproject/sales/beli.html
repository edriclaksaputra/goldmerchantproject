                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" name="stokLimit" value="1.050">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" name="stokLimit" value="1">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-1">
                                                    <input type="text" name="stokLimit" value="15000">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-1">
                                                    <input type="text" name="stokLimit" value="185000">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
