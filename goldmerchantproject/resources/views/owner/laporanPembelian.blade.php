                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td><button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal" onclick="notadetail('{{$detailpembelian->id}}', '{{ Carbon\Carbon::parse($detailpembelian->tanggal)->formatLocalized('%A %d %B %Y') }}', '{{$detailpembelian->namapenjual}}', '{{$detailpembelian->alamatpenjual}}', '{{$detailpembelian->id}}', '{{$detailpembelian->jenis}}', '{{$detailpembelian->namajenis}}', '{{$detailpembelian->beratasli}}', 'Rp {{number_format($detailpembelian->hargagram,2)}}', '{{$detailpembelian->namapenjual}}', '{{$detailpembelian->kadar}}', 'Rp {{number_format($detailpembelian->totalharga,2)}}', '{{$detailpembelian->namasales}}')">Detail Nota</button></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
