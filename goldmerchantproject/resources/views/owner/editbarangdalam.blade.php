@include('owner.layouts.header')
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">{{$detailbarang->namajenis}}</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-7">
                                        <br>
                                        <form method="post" action="/laporanbarang.dalam.edit.proses" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-sm-1">
                                                        <input type="text" name="idbarang" value="{{$detailbarang->id}}" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" name="ukuran" value="{{$detailbarang->ukuran}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-sm-1">
                                                        <input type="text" name="namabarang" value="{{$detailbarang->namajenis}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" name="beratasli" value="{{$detailbarang->beratasli}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-sm-1">
                                                        <input type="text" name="beratbulat" value="{{$detailbarang->beratpembulatan}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-1">
                                                        <input type="text" name="kadar" value="{{$detailbarang->kadar}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-1">
                                                        <input type="text" name="supplier" value="{{$detailbarang->supplier}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-1">
                                                        <input type="text" name="hargajual" value="{{$detailbarang->hargagram}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-1">
                                                        <input type="text" name="tanggalmasuk" readonly value="{{$detailbarang->tanggalmasuk}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-1">
                                                        <textarea name="keterangan" rows="5" cols="35">{{$detailbarang->keterangan}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <br><br><br>
